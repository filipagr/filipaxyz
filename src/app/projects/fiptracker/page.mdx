...
The tool has since been developed by an external contractor and renamed to FIL Poll. An [MVP](https://poll.fil.org/dashboard/fip_tracker) is currently in progress and being tested with various ecosystem participants to refine its usability and effectiveness.