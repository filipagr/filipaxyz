...
The biggest challenge was accommodating the **eight different FIP status** while ensuring **clarity and ease of use**. We tackled this by implementing color-coded status labels, making it easy for users to distinguish between different proposal stages at a glance.
...
The final solution presented a clean, structured layout, allowing users to expand a proposal card for more details when needed.
